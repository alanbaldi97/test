        ...
        <div v-if="$can('view flights')" class="col-12 col-md-12 q-mt-md" >
            <q-table  :data="airports" :columns="columns">
                <template v-slot:body-cell-actions="props">
                    ...
                    <q-btn v-if="$can('update flight')" color="primary" size="md" icon="edit" round flat  @click="onEdit(props.row)"></q-btn>
                    <q-btn v-if="$can('delete flight')" color="red" size="md" icon="delete" round flat  @click="onDelete(props.row)"></q-btn>
